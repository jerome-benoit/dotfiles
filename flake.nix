{
  ...
  inputs = {
    ...
    hermes-agent.inputs.pyproject-build-systems.inputs.nixpkgs.follows = "nixpkgs";
    hermes-agent.inputs.pyproject-build-systems.inputs.pyproject-nix.follows = "hermes-agent/pyproject-nix";
